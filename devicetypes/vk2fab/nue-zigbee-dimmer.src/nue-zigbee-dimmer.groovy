...
metadata {
	definition (name: "Nue Zigbee Dimmer", namespace: "VK2FAB", author: "VK2FAB", ocfDeviceType: "oic.d.light", runLocally: true, minHubCoreVersion: '000.019.00012', executeCommandsLocally: true, genericHandler: "zigbee") {
...
//        capability "Momentary"
        ...
        //fingerprint profileId: "0104", inClusters: "0000 0004 0003 0006 0008 0005 1000", outClusters: "0019", manufacturer: "3A Smart Home DE", model: "LXN56-DS27LX1.3", deviceJoinName: "3A Nue Dimmer Switch"
...
//			state "default", label: 'Push', action: "switch push", icon: "st.Transportation.transportation12", backgroundColor: "#bbff21"
//		}
		main "switch"
//		details(["switch", "toggleButton", "refresh"])
        details(["switch", "toggleButton", "refresh"])
	}
}
